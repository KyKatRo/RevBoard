...
const addMonth = async (month, revenue, expenses, operationalExpenses, nonOperationalExpenses) => {
    await pool.query(`
...
const addKPI = async (totalProfit, totalRevenue, totalExpenses, dayIds, monthIds) => {
    await pool.query(`
